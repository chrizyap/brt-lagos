...
void getCurrentLocation() async {
 ...
 print("the longitude is: ${position.longitude} and the latitude is: ${position.latitude} ");
  ...
  void _onAddMarkerButtonPressed() {
    setState(() {
      _markers.add(Marker(
        ...
        markerId: MarkerId(_tbsTerminal.toString(),),
       ...
       _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_cmsTerminal.toString(),),
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_leventis.toString(),),
        position: _leventis,
        infoWindow: InfoWindow(
          title: 'Leventis',
          //snippet: '5 Star Rating',
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_costain.toString(),),
        position: _costain,
        infoWindow: InfoWindow(
          title: 'Costain',
          //snippet: '5 Star Rating',
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_iponri.toString(),),
        position: _iponri,
        infoWindow: InfoWindow(
          title: 'Iponri',
          //snippet: '5 Star Rating',
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_stadium.toString(),),
        position: _stadium,
        infoWindow: InfoWindow(
          title: 'Stadium',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_barracks.toString(),),
        position: _barracks,
        infoWindow: InfoWindow(
          title: 'Barracks',
          //snippet: '5 Star Rating',
       ...
       _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_moshalashiTerminal.toString(),),
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_fadeyi.toString(),),
        position: _fadeyi,
        infoWindow: InfoWindow(
          title: 'Fadeyi',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_onipanu.toString(),),
        position: _onipanu,
        infoWindow: InfoWindow(
          title: 'Onipanu',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_palmgrove.toString(),),
        position: _palmgrove,
        infoWindow: InfoWindow(
          title: 'Palmgrove',
          //snippet: '5 Star Rating',
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueBlue)
          ...
          _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_obanikoro.toString(),),
        position: _obanikoro,
        infoWindow: InfoWindow(
          title: 'Obanikoro',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_anthony.toString(),),
        position: _anthony,
        infoWindow: InfoWindow(
          title: 'Anthony',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_idiroko.toString(),),
        position: _idiroko,
        infoWindow: InfoWindow(
          title: 'Idikoro',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_maryland.toString(),),
        position: _maryland,
        infoWindow: InfoWindow(
          title: 'Maryland',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_newGarage.toString(),),
        position: _newGarage,
        infoWindow: InfoWindow(
          title: 'New Garage',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_ojota.toString(),),
        position: _ojota,
        infoWindow: InfoWindow(
          title: 'Ojota',
          //snippet: '5 Star Rating',
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_ketu.toString(),),
        position: _ketu,
        infoWindow: InfoWindow(
          title: 'Ojota',
          //snippet: '5 Star Rating',
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_mile12Terminal.toString(),),
      ...
      _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_owodeOnirun.toString(),),
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_idera.toString(),),
        position: _idera,
        infoWindow: InfoWindow(
          title: 'Idera',
          //snippet: '5 Star Rating',
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_irawo.toString(),),
        position: _irawo,
        infoWindow: InfoWindow(
          title: 'Irawo',
          //snippet: '5 Star Rating',
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_majidunAwori.toString(),),
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_majidunOgolunto .toString(),),
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_argicTerminal.toString(),),
        ...
        _markers.add(Marker(
        // This marker id can be anything that uniquely identifies each marker.
        markerId: MarkerId(_ikoroduTerminal.toString(),),
            ...
            child: new ListView(
             ...
             // decoration: new Decoration(Colors.red),  
              ...
              new ListTile(
                ...
                trailing: Icon(Icons.arrow_right),
                 onTap: () {
                  ...
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new InfoPage("Info")
                  )); 
                 }
              ),
              ...
              Divider(
                ...
                trailing: Icon(Icons.arrow_right),
                onTap: () {
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new SettingsPage("Settings")
                )); 
                }
              ),
              ...
              new ListTile(
                ...
                trailing: Icon(Icons.arrow_right),
                onTap: () {
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new InfoPage("About")
                )); 
                }
              ),
